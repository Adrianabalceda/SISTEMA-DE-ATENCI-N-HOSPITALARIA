    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">Detalles del departamento</span>
          <h1 class="text-capitalize mb-5 text-lg">Cardiología</h1>
...
<section class="section cardiologia">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="department-img">
					<img src="images/especialidades/especialidades-9.jpg" alt="" class="img-fluid">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					<h3 class="text-md">Cardiología y salúd</h3>
					<div class="divider my-4"></div>
					<p class="lead">La cardiología es la rama de la medicina que se encarga del estudio, diagnóstico y tratamiento de las enfermedades del corazón y del sistema circulatorio.</p>
					...
					<h3 class="mt-5 mb-4">Servicios de Cardiología</h3>
					<div class="divider my-4"></div>
					<ul class="list-unstyled department-especialidades">
						<li><i class="icofont-check mr-2"></i>Rehabilitacion Cardiaca</li>
						<li><i class="icofont-check mr-2"></i>Monitoreo del ritmo cardiaco</li>
						<li><i class="icofont-check mr-2"></i>Consulta General de Cardiología</li>
						<li><i class="icofont-check mr-2"></i>Pruebas de esfuerzo</li>
						<li><i class="icofont-check mr-2"></i>Ecocardiografía</li>
						<li><i class="icofont-check mr-2"></i>Cateterizacion Cardiaca</li>
					</ul>

					<a href="appoinment.php" class="btn btn-main-2 btn-round-full">Reserve una cita<i class="icofont-simple-right ml-2  "></i></a>
				</div>
			</div>

			<div class="col-lg-4">
				<div class="sidebar-widget schedule-widget mt-5">
					<h5 class="mb-4">Horario de atencion</h5>

					<ul class="list-unstyled">
					  <li class="d-flex justify-content-between align-items-center">
					    <a href="#">Lunes - Viernes</a>
					...
					<div class="sidebar-contatct-info mt-4">
						<p class="mb-0">Necesitas ayuda urgente?</p>
						<h3>+51-4565-65768</h3>
					</div>
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 mr-auto col-sm-6">
				<div class="widget mb-5 mb-lg-0">
					...
					<p>El arte de la medicina consiste en mantener al paciente en buen estado de ánimo mientras la naturaleza le va curando.</p>
			...
			<div class="col-lg-2 col-md-6 col-sm-6">
				<div class="widget mb-5 mb-lg-0">
					...
					<ul class="list-unstyled footer-menu lh-35">
						<li><a href="about.php">Términos & Condiciones</a></li>
						<li><a href="about.php">Política de Privacidad</a></li>
						<li><a href="about.php">Apoyo de la Compañía </a></li>
						<li><a href="about.php">Preguntas & Respuestas</a></li>
						<li><a href="about.php">Licencia de la compañía</a></li>
					</ul>
				</div>
			</div>

			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="widget widget-contactanos mb-5 mb-lg-0">
					<h4 class="text-capitalize mb-3">Ponerse en contactanoso</h4>
					<div class="divider mb-4"></div>

					<div class="footer-contactanos-block mb-4">
						<div class="icon d-flex align-items-center">
							<i class="icofont-email mr-3"></i>
							<span class="h6 mb-0">Soporte disponible 24/7</span>
						</div>
						<h4 class="mt-2"><a href="tel:+23-345-67890">Soporte@email.com</a></h4>
					</div>

					<div class="footer-contactanos-block">
						<div class="icon d-flex align-items-center">
							<i class="icofont-support mr-3"></i>
							<span class="h6 mb-0">Lunes a Viernes : 08:30 - 18:00</span>
						</div>
						<h4 class="mt-2"><a href="tel:+23-345-67890">+51-456-6588</a></h4>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="footer-btm py-4 mt-5">
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6">
					<div class="copyright">
						&copy; Derechos Reservados a  <span class="text-color">Medifind</span> by <a href="https://themefisher.com/" target="_blank">Themefisher</a>
					</div>
				</div>
				<div class="col-lg-6">
