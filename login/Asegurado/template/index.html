...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="../../../logo byn/n/logo_small_icon_only.png" />
  </head>
  <body>
    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a class="sidebar-brand brand-logo" href="index.html"><img   width="300px" src="../../../logo color/logo_large.png" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.html"><img src="../../../logo color/logo_small_icon_only.png" alt="logo" /></a>
        </div>
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              ...
              <div class="nav-profile-text d-flex flex-column pr-3">
                <span class="font-weight-medium mb-2"><?php echo $nombres;?></span>
                <span class="font-weight-normal"><?php echo $apellidos;?></span>
              </div>
              <span class="badge badge-danger text-white ml-3 rounded"><?php echo $id_especialidad;?></span>
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/forms/basic_elements.html">
              ...
              <span class="menu-title">Internados</span>
            </a>
          </li>
          <li class="nav-item">
