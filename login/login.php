        ...
        <div class="row">
            <div class="col-md-5 p-5 fst-quote-container text-white min-h-100vh">
                <div class="d-flex align-items-center">
                    <img width="150" height="45" src="../logo byn/n/logo_small.png"></i>
                ...
                <div class="text-quote-login">
                    <div>
                        ...
                        <p class="pt-4 px-5 lh-lg mb-0">
                            El Hospital San Marcos pone a disposición de sus asegurados la plataforma Medifind mediante la cual a fin de priorizar la salud de sus asegurados.</p>
                        <div class="float-end">
                            ...
                            <div href="#" id="btnAsegurado" class="d-block shadow box-pre-login pointer bg-2nd text-decoration-none text-black rounded border-sacns-ge p-2 d-flex align-items-center mt-4 col-lg-10">
                                ...
                                <div class="d-flex w-100 justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <p class="text-secondary fs-6">Cuenta para para pacientes registrados en la base de datos de Medifind, esta cuenta estará a cargo del titular del seguro.</p>
                                    </div>
