...
<head>
    ...
    <title>Formulario_modificar_asegurado</title>
            ...
            <div class="container py-5">
                <div class="d-flex justify-content-between align-self-start align-items-center ">
                    <div id="cerrarSesion" class="d-flex align-items-center mb-5 pointer">
                        ...
                        <a href="modificar_tipo_usuario.php" class="mb-0 ms-2 text-secondary">Volver</a>
                    </div>
                ...
                <div class="container ml-4" id="containerLoginPageRight">
                    <div>
                        <h5 class="fw-bold fs-4" id="titleLoginPage">Modificar Asegurado</h5>
                    </div>
                </div>
