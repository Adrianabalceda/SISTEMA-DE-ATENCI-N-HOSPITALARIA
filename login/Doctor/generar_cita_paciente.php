		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Generar cita</h4>
							<p class="mb-30">Ingrese la información referente a la cita en los siguientes campos</p>
							</div>
					...
					<form>
						...
						<p class="mb-30"><b>RECUERDE:</b> De seleccionar un rango horario que no pertenezca al horario de atención de 8AM a 5PM de lunes a viernes, la cita no será validada en admisión</p>
