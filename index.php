		...
		<div class="row">
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<span class="text-uppercase text-sm letter-spacing ">Hospital San Juan</span>
					<h1 class="mb-3 mt-3">Sistema de atención Hospitalaria</h1>
					
					<b class="mb-4 pr-5">Plataforma en línea puesta a disposición de los asegurados del Hospital San Juan.</b><br></br>
