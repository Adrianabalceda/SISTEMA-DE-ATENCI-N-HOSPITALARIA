		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					<h3 class="text-md">Pediatría</h3>
					<div class="divider my-4"></div>
					<p class="lead">Nuestro destacado staff médico es responsable del cuidado integral de la salud de tus hijos, desde antes de su llegada, hasta su adolescencia</p>
					<p>Usando el juego y la comunicación como herramientas primarias, las intervenciones de la especialista facilitan la atención médica en eventos o procedimientos médicos y establecer relaciones terapéuticas con los niños y los padres para apoyar la participación de la familia en el cuidado de cada niño, con continuidad en su cuidado</p>


					<h3 class="mt-5 mb-4">Detalles del servicio</h3>
					<div class="divider my-4"></div>
					<ul class="list-unstyled department-service">
						<li><i class="icofont-check mr-2"></i>Control Pre Natal</li>
						<li><i class="icofont-check mr-2"></i>Control Post natal</li>
						<li><i class="icofont-check mr-2"></i>Control de Niño Sano</li>
						<li><i class="icofont-check mr-2"></i>Estimulación para menores de 2 años</li>
						<li><i class="icofont-check mr-2"></i>Urgencias pediátricas</li>
						<li><i class="icofont-check mr-2"></i>Emergencias pediátricas</li>
					</ul>
...
<footer class="footer section gray-bg">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-2 col-md-6 col-sm-6">
				<div class="widget mb-5 mb-lg-0">
					<h4 class="text-capitalize mb-3">Sobre Nosotros</h4>
					<div class="divider mb-4"></div>
				...
				<div class="widget widget-contact mb-5 mb-lg-0">
					...
					<div class="footer-contact-block mb-4">
						<div class="icon d-flex align-items-center">
							...
							<span class="h6 mb-0">Asistencia disponible las 24 horas</span>
						</div>
						<h4 class="mt-2"><a href="tel:+23-345-67890">Contactenos@email.com</a></h4>
					</div>
				...
				<div class="col-lg-6">
					<div class="subscribe-form text-lg-right mt-5 mt-lg-0">
						<form action="#" class="subscribe">
							<input type="text" class="form-control" placeholder="Escriba su correo aquí">
