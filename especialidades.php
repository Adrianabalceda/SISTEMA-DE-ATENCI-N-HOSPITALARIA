    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">Nuestros servicios</span>
          <h1 class="text-capitalize mb-5 text-lg">Lo que hacemos</h1>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-block mb-5">
					...
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Servicio de vida infantil</h4>
						<p class="mb-4">Promovemos el afrontamiento eficaz de procedimientos médicos brindando apoyo emocional y preparación psicológica a los pacientes de pediatría y sus familiares.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-block mb-5">
					...
					<div class="content">
						<h4 class="mt-4 mb-2  title-color">Cuidado personal</h4>
						<p class="mb-4">Las 24 horas, los 365 días del año con médicos emergenciólogos, pediatras, cirujanos generales, traumatólogos, ginecólogos y cardiólogos. A esto se suman los demás especialistas de la clínica, que están atentos al llamado inmediato y de reten permanente.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-block mb-5">
					...
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Tomografias computarizadas</h4>
						<p class="mb-4">Contamos con equipos de última generación, cómodas instalaciones y personal médico y administrativo altamente calificado, brindando a los pacientes una alta atención calificada.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-block mb-5 mb-lg-0">
					...
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Staff Médico</h4>
						<p class="mb-4">Todos nuestros médicos cuentan con amplia experiencia en el campo clínico y quirúrgico y se encuentran capacitados para resolver todo tipo de emergencias.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-block mb-5 mb-lg-0">
					...
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Examenes de laboratorio</h4>
						<p class="mb-4">Contamos con modernos equipos de monitoreo, diagnóstico y tratamiento que permiten evaluar un gran número de variables clínicas, detectar alteraciones de los diferentes órganos comprometidos e infundir medicamentos especiales en dosis que deben ser estrictamente controladas.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="service-block mb-5 mb-lg-0">
					...
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Alzheimer</h4>
						<p class="mb-4">Contamos con un equipo de profesionales multidisciplinario en el campo de las patologías neurodegenerativas apoyados en tecnología de punta para el diagnóstico y tratamiento .</p>
					</div>
				</div>
			</div>
		</div>
