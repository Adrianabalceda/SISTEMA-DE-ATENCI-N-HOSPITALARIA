			...
			<div class="row">
				<div class="col-md-12">
					<div class="block text-center">
						<span class="text-white">Reserve su asiento</span>
						<h1 class="text-capitalize mb-5 text-lg">Cita</h1>
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="mt-3">
						...
						<span class="h3">¡Llame para un servicio de emergencia!</span>
						<h2 class="text-color mt-3">555 - 5555</h2>
					</div>
				</div>

				<div class="col-lg-8">
					<div class="appoinment-wrap mt-5 mt-lg-0 pl-lg-5">
						<h2 class="mb-2 title-color">Reservar una cita</h2>
						<p class="mb-4"></p>
						<form id="#" class="appoinment-form" method="post" action="#">
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group">
										<select class="form-control" id="exampleFormControlSelect2">
											<option>Seleccionar médicos</option>
											<option>John Marshal</option>
											<option>Marshal Root</option>
											<option>Siamon John</option>
											<option>Rishat Ahmed</option>
										</select>
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="form-group">
										<input name="date" id="date" type="text" class="form-control" placeholder="dd/mm/aaaa">
									</div>
								</div>

								<div class="col-lg-6">
									<div class="form-group">
										<input name="time" id="time" type="text" class="form-control" placeholder="Hora">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
								...
								<div class="col-lg-6">
									<div class="form-group">
										<input name="phone" id="phone" type="Number" class="form-control" placeholder="Número telefónico">
									</div>
								</div>
							</div>
