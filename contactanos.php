    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-5 text-lg">Póngase en contacto</h1>
         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="contact-block mb-4 mb-lg-0">
                    ...
                    <h5>Contáctenos via email</h5>
					plat_online@medifind.com
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="contact-block mb-4 mb-lg-0">
					...
					Av. Canto Grande, San Juan de Lurigancho
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input name="name" id="name" type="text" class="form-control" placeholder="Nombres y Apellidos" >
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                         ...
                         <div class="col-lg-6">
                            <div class="form-group">
                                <input name="subject" id="subject" type="text" class="form-control" placeholder="Tipo de consulta">
                            </div>
                        </div>
                         <div class="col-lg-6">
                            <div class="form-group">
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="widget widget-contact mb-5 mb-lg-0">
					<h4 class="text-capitalize mb-3">Póngase en contacto</h4>
					<div class="divider mb-4"></div>
