    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">Tratamiento del sistema nervioso</span>
          <h1 class="text-capitalize mb-5 text-lg">Neurología</h1>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					<h3 class="text-md">Neurología</h3>
					<div class="divider my-4"></div>
					<p class="lead">La neurología trata los trastornos del sistema nervioso. Específicamente se ocupa de la prevención, diagnóstico, tratamiento y rehabilitación de todas las enfermedades que involucran al sistema nervioso central, sistema nervioso periférico y el sistema nervioso autónomo.</p>
					<p>Existe gran número de enfermedades neurológicas, las cuales pueden afectar el sistema nervioso central (cerebro y médula espinal), el sistema nervioso periférico, o el sistema nervioso autónomo.</p>
