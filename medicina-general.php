    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          <span class="text-white">El mejor tratamiento médico para todas sus necesidades</span>
          <h1 class="text-capitalize mb-5 text-lg">Medicina general</h1>
		...
		<div class="row">
			<div class="col-lg-8">
				<div class="department-content mt-5">
					<h3 class="text-md">Medicina general</h3>
					<div class="divider my-4"></div>
					<p class="lead">La medicina general es el primer nivel de atención médica. La consulta está orientada al abordaje integral del paciente en su aspecto físico, mental y social.</p>
					<p>Dependiendo del caso se procede a la identificación de factores de riesgo para enfermedades latentes o potenciales en corto, mediano y largo plazo; orientando al paciente sobre la manera más adecuada de prevenirlas e incentivando estilos de vida saludables.
					<br>El médico general es el profesional capacitado para realizar el diagnóstico y tratamiento de diferentes patologías comunes de manera ambulatoria y derivar al especialista indicado cuando corresponda.</p>

					<h3 class="mt-5 mb-4">Características de los servicios</h3>
					<div class="divider my-4"></div>
					<ul class="list-unstyled department-service">
						<li><i class="icofont-check mr-2"></i>La asistencia sanitaria a demanda, programada y urgente del enfermo.</li>
						...
						<li><i class="icofont-check mr-2"></i>La rehabilitación básica.</li>
						<li><i class="icofont-check mr-2"></i>Las atenciones y servicios específicos relativos a la mujer, la infancia, la adolescencia, los adultos, la tercera edad, los grupos de riesgo y los enfermos crónicos.</li>
						<li><i class="icofont-check mr-2"></i>La atención paliativa a enfermos terminales.</li>
						<li><i class="icofont-check mr-2"></i>La atención a la salud mental, en coordinación con los servicios de atención especializada.</li>
						<li><i class="icofont-check mr-2"></i>La atención a la salud estomatognática.</li>
					</ul>

					<a href="appoinment.html" class="btn btn-main-2 btn-round-full">Haga una cita<i class="icofont-simple-right ml-2  "></i></a>
				</div>
			</div>
